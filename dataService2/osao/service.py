serviceCatalog = [
            {
                "endpoints": [
                    {
                        "adminURL": "http://192.168.0.51:8774/v2/tenant_id",
                        "id": "8eeb6834d2b147269f4d8e7d2721d65e",
                        "internalURL": "http://192.168.0.51:8774/v2/tenant_id",
                        "publicURL": "http://192.168.0.51:8774/v2/tenant_id",
                        "region": "RegionOne"
                    }
                ],
                "endpoints_links": [],
            ...
            },
            {
                "endpoints": [
                    {
                        "adminURL": "http://192.168.0.51:8776/v1/tenant_id",
                        "id": "9e526642c2b4423998af42ed6100b2b4",
                        "internalURL": "http://192.168.0.51:8776/v1/tenant_id",
                        "publicURL": "http://192.168.0.51:8776/v1/tenant_id",
                        "region": "RegionOne"
                    }
                ],
                "endpoints_links": [],
                ...
                "endpoints": [
                    {
                        ...
                        "internalURL": "http://192.168.0.55:8888/v1/AUTH_tenant_id",
                        "publicURL": "http://192.168.0.55:8888/v1/AUTH_tenant_id",
                        "region": "RegionOne"
                    }
                ],
                "endpoints_links": [],
